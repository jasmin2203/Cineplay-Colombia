  ...
  <body background="background-color: #3a1e1e;">
    ...
    <div  class="container">
      <table id="fresh-table" class="table" width="100%">
        <thead>
          <th data-field="name" data-sortable="true">Pelicula</th>
          <th data-field="shows">Ver</th>
          <th>Accion</th>
        ...
        <tbody>
          ...
          while ($movieRow=$movieRes->fetch_object()) {
            ...
            <tr>
              ...
              <td>
                <a href="javascript:void(0)" onclick="openLoginModal()"; class="btn btn-primary btn-xs">Comprar Boleta</a>
              </td>
            </tr>
            <?php  } ?>
          </tbody>
