	...
	<div class="bg">
		...
		<div class="container">  
			<form id="contact" action="addMovie.php" method="post" enctype="multipart/form-data">
				...
				<input name="imdb" placeholder="Ranking imdb" type="text" tabindex="1" required>


				<input name="directorName" placeholder="Director" type="text" tabindex="1" required>

				<TEXTAREA name="description" placeholder="descripcion" type="textArea" tabindex="1" required></TEXTAREA>
...
class AddProduct{
	...
	public function productAdd($conn)
	{
		...
		$stmt->close();
		$_SESSION['msg']="Pelicula Agregada Correctamente";
